...
(function ($) {
    ...
    $('.reply_msg_post').click(function () {
        if ($(this).hasClass('checked')) {
            $.post("#/service/sendSMS", {
                timestamp: YYToken.timestamp,
                token: YYToken.token,
                content: $('#reply_msg_area').val(),
                nickname: reply_nickname
            }, function () {
                $.get("#/sms", {id: reply_post_id}, function (data) {
